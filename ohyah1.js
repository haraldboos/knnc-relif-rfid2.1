...
function getingfdate(){
    ...
    // console.log(hours,minutes);
    // return
    let fte = `day_${date}_${month}_${year}`;
    console.log(fte);
    return fte;
}
...
// async function getlesson(time, datetimeData) {
//     // Assuming `datetimeData` is an array containing lesson start times
//     // in ascending order, e.g., ["08:00:00", "09:30:00", ...]
    
//     for (let i = 0; i < datetimeData.length; i++) {
//         if (time < datetimeData[i]) {
//             return i + 1; // Lessons are 1-indexed
//         }
//     }
    
//     // If the current time is after the last lesson, return the last lesson number
//     return datetimeData.length;
// }
